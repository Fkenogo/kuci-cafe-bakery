...
export const Layout: React.FC<LayoutProps> = ({ children, activeTab, setActiveTab, cartCount, userPhoto }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen max-w-md mx-auto relative bg-[#fffdfa] shadow-xl overflow-x-hidden">
      {/* Top Header */}
      <header className="sticky top-0 z-40 bg-[#fffdfa]/95 backdrop-blur-md px-4 py-3 flex items-center justify-between border-b border-[#f5f5dc]">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-[#f97316] rounded-full flex items-center justify-center text-white font-serif text-xl">K</div>
          <div>
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t border-[#f5f5dc] z-50 safe-bottom">
